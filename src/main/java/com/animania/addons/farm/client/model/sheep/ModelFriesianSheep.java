...
public class ModelFriesianSheep<T extends EntityAnimaniaSheep> extends EntityModel<T>
{
	...
	public ModelFriesianSheep(ModelPart root)
	{
	...
	protected static PartDefinition buildFriesianHead(PartDefinition root)
	{
		...
		headNode.addOrReplaceChild("right_horn1", CubeListBuilder.create().texOffs(80, 15)
				.addBox(-5F, -1F, -1F, 5, 2, 2), PartPose.offset(-2.1F, -5.143049F, -9.997662F));
		headNode.addOrReplaceChild("left_horn1", CubeListBuilder.create().texOffs(80, 15)
				.addBox(0F, -1F, -1F, 5, 2, 2), PartPose.offset(2.1F, -5.143049F, -9.997662F));
		headNode.addOrReplaceChild("right_horn2", CubeListBuilder.create().texOffs(80, 15)
				.addBox(-6F, -1F, -1F, 6, 2, 2), PartPose.offset(-4.404046F, -8.300139F, -8.178572F));
		headNode.addOrReplaceChild("left_horn2", CubeListBuilder.create().texOffs(80, 15)
				.addBox(0F, -1F, -1F, 6, 2, 2), PartPose.offset(4.404046F, -8.300139F, -8.178572F));
		headNode.addOrReplaceChild("right_horn3", CubeListBuilder.create().texOffs(80, 15)
				.addBox(-6F, -1F, -1F, 6, 2, 2), PartPose.offset(-7.494238F, -8.0752504F, -4.019722F));
		headNode.addOrReplaceChild("left_horn3", CubeListBuilder.create().texOffs(80, 15)
				.addBox(0F, -1F, -1F, 6, 2, 2), PartPose.offset(7.494238F, -8.0752504F, -4.019722F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		this.leftHorn3.xRot = -0.2553108F; this.leftHorn3.zRot = 1.064569F;
		this.rightHorn3.xRot = -0.2553108F; this.rightHorn3.zRot = -1.064569F;
