...
public class ModelMerinoRam<T extends EntityAnimaniaSheep> extends EntityModel<T>
{
	...
	public ModelMerinoRam(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		...
		root.addOrReplaceChild("right_front_leg_wool", CubeListBuilder.create().texOffs(98, 65)
				.addBox(-2F, -2F, -2.5F, 4, 12, 5), PartPose.offset(-4F, 9.149483F, -3.08116F));
		...
		root.addOrReplaceChild("right_back_leg_wool", CubeListBuilder.create().texOffs(99, 83)
				.addBox(-2F, -1F, -2.5F, 4, 14, 5), PartPose.offset(-4.5F, 7.043413F, 16.245048F));
		...
		root.addOrReplaceChild("wool_body1", CubeListBuilder.create().texOffs(40, 99)
				.addBox(-5F, -6.5F, -6F, 10, 17, 12), PartPose.offset(0F, 7.704449F, 7.009472F));
		root.addOrReplaceChild("wool_body2", CubeListBuilder.create().texOffs(1, 103)
				.addBox(-5.5F, -6.5F, -5F, 11, 17, 8), PartPose.offset(0F, 7.153107F, -1.771488F));
		root.addOrReplaceChild("wool_hips", CubeListBuilder.create().texOffs(85, 104)
				.addBox(-6F, -6F, -6F, 12, 16, 8), PartPose.offset(0F, 7.308489F, 18.23427F));
	...
	protected static PartDefinition buildHead(PartDefinition root)
	{
		...
		headNode.addOrReplaceChild("neck_wool", CubeListBuilder.create().texOffs(59, 69)
				.addBox(-3.5F, -3F, -5F, 7, 11, 10), PartPose.offset(0F, -2.251757F, -2.0444F));
		headNode.addOrReplaceChild("neck_wool2", CubeListBuilder.create().texOffs(30, 75)
				.addBox(-4F, -3F, -2F, 8, 12, 4), PartPose.offset(0F, -5.042712F, -5.98717F));
