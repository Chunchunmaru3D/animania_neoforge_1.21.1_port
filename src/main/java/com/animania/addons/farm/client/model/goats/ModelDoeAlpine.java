...
public class ModelDoeAlpine<T extends EntityAnimaniaGoat> extends EntityModel<T>
{
	...
	public ModelDoeAlpine(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		...
		root.addOrReplaceChild("right_front_leg", CubeListBuilder.create().texOffs(62, 4)
				.addBox(-1.5F, -2F, -2F, 3, 16, 4), PartPose.offset(-4F, 10.72712F, -1.250051F));
		root.addOrReplaceChild("udder", CubeListBuilder.create().texOffs(5, 14)
				.addBox(-3F, -2F, -3F, 6, 4, 6), PartPose.offset(0F, 14.37547F, 17.50334F));
		root.addOrReplaceChild("udder1", CubeListBuilder.create().texOffs(10, 19)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(2F, 16.87547F, 15.50334F));
		root.addOrReplaceChild("udder2", CubeListBuilder.create().texOffs(10, 19)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(-2F, 16.87547F, 15.50334F));
		root.addOrReplaceChild("udder3", CubeListBuilder.create().texOffs(10, 19)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(-2F, 16.87547F, 19.50334F));
		root.addOrReplaceChild("udder4", CubeListBuilder.create().texOffs(10, 19)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(2F, 16.87547F, 19.50334F));
	...
	public static void renderScaled(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color, ModelPart part, float scale)
	{
		poseStack.pushPose();
