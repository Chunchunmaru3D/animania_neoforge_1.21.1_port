...
public class ModelCowLonghorn<T extends EntityAnimaniaCow> extends EntityModel<T>
{
	...
	public ModelCowLonghorn(ModelPart root)
	{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		head.addOrReplaceChild("horn1", CubeListBuilder.create().texOffs(1, 59)
				.addBox(-2.5F, -1F, -1F, 5, 2, 2), PartPose.offset(6F, -2.5F, 0F));
		head.addOrReplaceChild("horn1a", CubeListBuilder.create().texOffs(17, 59)
				.addBox(-1F, -1F, -1F, 2, 2, 2), PartPose.offset(9.5F, -3.5F, 0F));
		head.addOrReplaceChild("horn1b", CubeListBuilder.create().texOffs(25, 59)
				.addBox(-0.5F, -1F, -1F, 1, 2, 2), PartPose.offset(11F, -4.5F, 0F));
		head.addOrReplaceChild("horn1c", CubeListBuilder.create().texOffs(26, 60)
				.addBox(-0.5F, -1F, -0.5F, 1, 2, 1), PartPose.offset(12F, -5.5F, 0F));

		head.addOrReplaceChild("horn2", CubeListBuilder.create().texOffs(1, 59)
				.addBox(-2.5F, -1F, -1F, 5, 2, 2), PartPose.offset(-6F, -2.5F, 0F));
		head.addOrReplaceChild("horn2a", CubeListBuilder.create().texOffs(17, 59)
				.addBox(-1F, -1F, -1F, 2, 2, 2), PartPose.offset(-9.5F, -3.5F, 0F));
		head.addOrReplaceChild("horn2b", CubeListBuilder.create().texOffs(25, 59)
				.addBox(-0.5F, -1F, -1F, 1, 2, 2), PartPose.offset(-11F, -4.5F, 0F));
		head.addOrReplaceChild("horn2c", CubeListBuilder.create().texOffs(26, 60)
				.addBox(-0.5F, -1F, -0.5F, 1, 2, 1), PartPose.offset(-12F, -5.5F, 0F));
	...
	public void renderToBuffer(com.mojang.blaze3d.vertex.PoseStack poseStack, com.mojang.blaze3d.vertex.VertexConsumer buffer, int packedLight, int packedOverlay, int color)
	{
		...
		if (this.sleeping)
		{
			ModelCow.renderScaled(poseStack, buffer, packedLight, packedOverlay, color, this.leg1, 0.95F);
			ModelCow.renderScaled(poseStack, buffer, packedLight, packedOverlay, color, this.leg2, 0.97F);
			ModelCow.renderScaled(poseStack, buffer, packedLight, packedOverlay, color, this.leg3, 0.97F);
			ModelCow.renderScaled(poseStack, buffer, packedLight, packedOverlay, color, this.leg4, 0.95F);
		}
		else
		{
