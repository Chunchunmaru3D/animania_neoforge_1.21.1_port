...
public class ModelDoeKinder<T extends EntityAnimaniaGoat> extends EntityModel<T>
{
	...
	public ModelDoeKinder(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(81, 5)
				.addBox(-5F, -5F, -6.5F, 10, 14, 13), PartPose.offset(0F, 7F, 2F));
