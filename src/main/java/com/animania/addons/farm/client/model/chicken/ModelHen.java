...
public class ModelHen<T extends EntityAnimaniaChicken> extends EntityModel<T>
{
	...
	public ModelHen(ModelPart root)
	{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		root.addOrReplaceChild("wing1", CubeListBuilder.create().texOffs(30, 6)
				.addBox(-0.5F, -1.5F, 0F, 1, 3, 4), PartPose.offset(-3.5F, 16.8998F, -1.360003F));
		...
		PartDefinition tail1 = root.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(36, 20)
				.addBox(-2.5F, -2F, -2F, 5, 4, 4), PartPose.offset(0F, 18.02851F, 5.041247F));

		tail1.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(38, 14)
				.addBox(-2F, -1F, -1.5F, 4, 2, 3), PartPose.offset(0F, -1.264F, 2.28313F));

		 
		PartDefinition leg1Pivot = root.addOrReplaceChild("leg1_pivot", CubeListBuilder.create(),
				PartPose.offset(-1.5F, 20F, 1.75F));
		leg1Pivot.addOrReplaceChild("leg1_top", CubeListBuilder.create().texOffs(39, 0)
				.addBox(-1F, -1F, -1F, 2, 2, 2), PartPose.offset(0F, 1.29997F, 0F));
		leg1Pivot.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(35, 0)
				.addBox(-0.5F, -2F, -0.5F, 1, 2, 1), PartPose.offset(0F, 4.09997F, -0.7499F));
		leg1Pivot.addOrReplaceChild("foot1", CubeListBuilder.create().texOffs(25, 0)
				.addBox(-0.2F, -0.2F, -1.5F, 1, 1, 3), PartPose.offset(-1F, 3.09997F, -1.75F));
		...
		neck.addOrReplaceChild("neck2", CubeListBuilder.create().texOffs(21, 21)
				.addBox(-2F, -2F, -1.5F, 4, 4, 3), PartPose.offsetAndRotation(0F, -0.7998F, -1.556894F, -0.7360098F, 0F, 0F));
		neck.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-1.5F, -2F, -1.5F, 3, 4, 3), PartPose.offsetAndRotation(0F, -3.890F, -2.889997F, 0.05872217F, 0F, 0F));
		neck.addOrReplaceChild("crest", CubeListBuilder.create().texOffs(20, 4)
				.addBox(0F, -1.5F, -1.5F, 0, 3, 3), PartPose.offsetAndRotation(0F, -5.299F, -4.139997F, 0.3490659F, 0F, 0F));
		neck.addOrReplaceChild("crest_bottom", CubeListBuilder.create().texOffs(22, 6)
				.addBox(0F, -1F, -0.5F, 0, 2, 1), PartPose.offset(0F, -2.148F, -4.739997F));
		neck.addOrReplaceChild("beak_bottom", CubeListBuilder.create().texOffs(19, 0)
				.addBox(-0.5F, -0.5F, -1F, 1, 1, 2), PartPose.offsetAndRotation(0F, -3.1499F, -4.889997F, 0.05872219F, 0F, 0F));
		neck.addOrReplaceChild("beak_top", CubeListBuilder.create().texOffs(19, 0)
				.addBox(-0.5F, -0.5F, -1F, 1, 1, 2), PartPose.offsetAndRotation(0F, -3.4499F, -4.789997F, 0.3169494F, 0F, 0F));
