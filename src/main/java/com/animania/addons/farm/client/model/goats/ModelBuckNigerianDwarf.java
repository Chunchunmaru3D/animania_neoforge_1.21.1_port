...
public class ModelBuckNigerianDwarf<T extends EntityAnimaniaGoat> extends EntityModel<T>
{
	...
	public ModelBuckNigerianDwarf(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(81, 5)
				.addBox(-5F, -6.5F, -6.5F, 10, 13, 13), PartPose.offset(0F, 9F, 2F));
		root.addOrReplaceChild("butt", CubeListBuilder.create().texOffs(71, 40)
				.addBox(-4.5F, -6F, 0F, 9, 12, 18), PartPose.offset(0F, 9.435779F, 6.980974F));
		root.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(38, 10)
				.addBox(-1.5F, -3.5F, -1.5F, 3, 5, 3), PartPose.offset(0F, 5.103979F, 24.90402F));
		root.addOrReplaceChild("left_back_leg", CubeListBuilder.create().texOffs(47, 28)
				.addBox(-1.5F, -2F, -2.5F, 3, 16, 5), PartPose.offset(5F, 10.21395F, 18.9974F));
		...
		root.addOrReplaceChild("reproductive1", CubeListBuilder.create().texOffs(22, 38)
				.addBox(-1F, -2F, -2F, 2, 4, 4), PartPose.offsetAndRotation(0F, 14.20496F, 15.5981F, 0.07853982F, 0F, 0F));
		root.addOrReplaceChild("reproductive2", CubeListBuilder.create().texOffs(10, 37)
				.addBox(-1.5F, -2F, -1F, 3, 4, 2), PartPose.offsetAndRotation(0F, 14.04804F, 17.59194F, 0.07853982F, 0F, 0F));
	...
	protected static PartDefinition buildHead(PartDefinition root)
	{
		PartDefinition headNode = root.addOrReplaceChild("head_node", CubeListBuilder.create(),
				PartPose.offset(0F, 8.651377F, -1.984779F));

		headNode.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(85, 78)
				.addBox(-2.5F, -4.5F, -14.5F, 5, 9, 15), PartPose.offsetAndRotation(0F, 0F, 0F, -0.9705301F, 0F, 0F));
		headNode.addOrReplaceChild("head", CubeListBuilder.create().texOffs(9, 60)
				.addBox(-3F, -3.5F, -7.5F, 6, 7, 7), PartPose.offsetAndRotation(0F, -2.08095F - 8.651377F, -6.665287F + 1.984779F, 0.2771511F, 0F, 0F));
		headNode.addOrReplaceChild("right_ear1", CubeListBuilder.create().texOffs(60, 84)
				.addBox(-4F, -1F, -0.5F, 4, 2, 1), PartPose.offsetAndRotation(-2.5F, -3.183779F - 8.651377F, -10.09804F + 1.984779F, 0.3975939F, -0.2030238F, 0.321354F));
		headNode.addOrReplaceChild("right_ear2", CubeListBuilder.create().texOffs(49, 80)
				.addBox(-2.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offsetAndRotation(-4.761655F, -3.911814F - 8.651377F, -10.87578F + 1.984779F, 0.397594F, -0.2030239F, 0.3213542F));
		headNode.addOrReplaceChild("left_ear1", CubeListBuilder.create().texOffs(60, 84)
				.addBox(0F, -1F, -0.5F, 4, 2, 1), PartPose.offsetAndRotation(2.5F, -3.183779F - 8.651377F, -10.09804F + 1.984779F, 0.3975939F, 0.2030238F, -0.321354F));
		headNode.addOrReplaceChild("left_ear2", CubeListBuilder.create().texOffs(49, 80)
				.addBox(1.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offsetAndRotation(4.761655F, -3.911814F - 8.651377F, -10.87578F + 1.984779F, 0.397594F, 0.2030239F, -0.3213542F));
		headNode.addOrReplaceChild("right_horn_bud", CubeListBuilder.create().texOffs(38, 64)
				.addBox(-1.5F, -0.5F, -1.5F, 3, 1, 3), PartPose.offsetAndRotation(-1.8F, -5.188705F - 8.651377F, -9.628707F + 1.984779F, 0.1493225F, -0.1260779F, -0.09751795F));
		headNode.addOrReplaceChild("right_horn1", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -6.5F, -1F, 2, 5, 2), PartPose.offsetAndRotation(-1.064111F, -3.611816F - 8.651377F, -10.31565F + 1.984779F, -0.6566103F, 0.013392F, -0.3415252F));
		headNode.addOrReplaceChild("right_horn2", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -7F, -1F, 2, 6, 2), PartPose.offsetAndRotation(-2.803532F, -7.872532F - 8.651377F, -7.639694F + 1.984779F, -1.146275F, -0.02247968F, -0.2173545F));
		headNode.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(8, 111)
				.addBox(-1.5F, -0.5F, -5.5F, 3, 1, 6), PartPose.offsetAndRotation(0F, 2.35008F - 8.651377F, -11.64283F + 1.984779F, 0.2771511F, 0F, 0F));
		headNode.addOrReplaceChild("beard", CubeListBuilder.create().texOffs(31, 111)
				.addBox(-1F, -1F, 0F, 2, 6, 4), PartPose.offsetAndRotation(0F, 3.581356F - 8.651377F, -15.97111F + 1.984779F, 0.1083812F, 0F, 0F));
		headNode.addOrReplaceChild("snout3", CubeListBuilder.create().texOffs(9, 86)
				.addBox(-1.5F, 0F, -5F, 3, 2, 5), PartPose.offsetAndRotation(0F, -1.712044F - 8.651377F, -14.35791F + 1.984779F, 0.6541421F, 0F, 0F));
		headNode.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(40, 91)
				.addBox(-1F, 0F, 0F, 2, 2, 2), PartPose.offsetAndRotation(0F, 1.40766F - 8.651377F, -18.92873F + 1.984779F, 0.4028149F, 0F, 0F));
		headNode.addOrReplaceChild("snout1", CubeListBuilder.create().texOffs(11, 76)
				.addBox(-1.5F, 0F, -5.5F, 3, 2, 6), PartPose.offsetAndRotation(-0.01F, -2.914343F - 8.651377F, -14.69993F + 1.984779F, 1.100248F, 0F, 0F));
		headNode.addOrReplaceChild("snout2", CubeListBuilder.create().texOffs(10, 96)
				.addBox(-2F, -0.5F, -5F, 4, 3, 6), PartPose.offsetAndRotation(0F, -0.116581F - 8.651377F, -13.76463F + 1.984779F, 0.4028149F, 0F, 0F));
		headNode.addOrReplaceChild("left_horn_bud", CubeListBuilder.create().texOffs(38, 64)
				.addBox(-1.5F, -0.5F, -1.5F, 3, 1, 3), PartPose.offsetAndRotation(1.8F, -5.188705F - 8.651377F, -9.628707F + 1.984779F, 0.1493225F, 0.1260779F, 0.09751797F));
		headNode.addOrReplaceChild("left_horn1", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -6.5F, -1F, 2, 5, 2), PartPose.offsetAndRotation(1.064111F, -3.611816F - 8.651377F, -10.31565F + 1.984779F, -0.6566105F, -0.01339201F, 0.3415253F));
		headNode.addOrReplaceChild("left_horn2", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -7F, -1F, 2, 6, 2), PartPose.offsetAndRotation(2.803532F, -7.872532F - 8.651377F, -7.639694F + 1.984779F, -1.146275F, 0.02247965F, 0.2173546F));
