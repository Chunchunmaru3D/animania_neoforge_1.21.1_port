...
public class ModelDoeNigerianDwarf<T extends EntityAnimaniaGoat> extends EntityModel<T>
{
	...
	public ModelDoeNigerianDwarf(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		...
		root.addOrReplaceChild("right_front_leg", CubeListBuilder.create().texOffs(62, 4)
				.addBox(-1.5F, -1F, -2F, 3, 14, 4), PartPose.offset(-4F, 11.72712F, -1.250051F));
		root.addOrReplaceChild("udder", CubeListBuilder.create().texOffs(4, 11)
				.addBox(-3F, -2F, -3F, 6, 4, 6), PartPose.offset(0F, 16.36405F, 17.24187F));
		root.addOrReplaceChild("udder1", CubeListBuilder.create().texOffs(9, 16)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(2F, 18.86405F, 15.24187F));
		root.addOrReplaceChild("udder2", CubeListBuilder.create().texOffs(9, 16)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(-2F, 18.86405F, 15.24187F));
		root.addOrReplaceChild("udder3", CubeListBuilder.create().texOffs(9, 16)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(-2F, 18.86405F, 19.24187F));
		root.addOrReplaceChild("udder4", CubeListBuilder.create().texOffs(9, 16)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(2F, 18.86405F, 19.24187F));
