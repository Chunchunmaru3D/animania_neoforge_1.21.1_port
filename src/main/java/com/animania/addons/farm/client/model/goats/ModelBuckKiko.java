...
public class ModelBuckKiko<T extends EntityAnimaniaGoat> extends EntityModel<T>
{
	...
	public ModelBuckKiko(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		...
		root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(81, 5)
				.addBox(-5F, -5F, -6.5F, 10, 14, 13), PartPose.offsetAndRotation(0F, 7F, 2F, -0.08726646F, 0F, 0F));
		root.addOrReplaceChild("butt", CubeListBuilder.create().texOffs(71, 40)
				.addBox(-4.5F, -6.5F, 0F, 9, 13, 18), PartPose.offset(0F, 9.428168F, 6.806662F));
		root.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(38, 10)
				.addBox(-1.5F, -5F, -1.5F, 3, 8, 3), PartPose.offset(0F, 4.09654F, 24.71124F));
		root.addOrReplaceChild("left_back_leg", CubeListBuilder.create().texOffs(47, 28)
				.addBox(-1.5F, -3F, -2.5F, 3, 18, 5), PartPose.offset(5F, 10.20634F, 18.82309F));
		...
		root.addOrReplaceChild("left_front_leg", CubeListBuilder.create().texOffs(62, 4)
				.addBox(-1.5F, -2F, -2F, 3, 16, 4), PartPose.offset(4F, 11.71951F, -1.424363F));
		...
		root.addOrReplaceChild("reproductive1", CubeListBuilder.create().texOffs(22, 38)
				.addBox(-1F, -2F, -2F, 2, 4, 4), PartPose.offsetAndRotation(0F, 14.2845F, 16.41999F, 0.07853982F, 0F, 0F));
		root.addOrReplaceChild("reproductive2", CubeListBuilder.create().texOffs(10, 37)
				.addBox(-1.5F, -2F, -1F, 3, 4, 2), PartPose.offsetAndRotation(0F, 14.45882F, 18.41238F, 0.07853982F, 0F, 0F));
	...
	protected static PartDefinition buildHead(PartDefinition root)
	{
		PartDefinition headNode = root.addOrReplaceChild("head_node", CubeListBuilder.create(),
				PartPose.offset(0F, 8.730923F, -1.162896F));
		...
		headNode.addOrReplaceChild("head", CubeListBuilder.create().texOffs(9, 60)
				.addBox(-3F, -3.5F, -7.5F, 6, 7, 7), PartPose.offsetAndRotation(0F, -1.888433F - 8.730923F, -6.00844F + 1.162896F, 0.2771511F, 0F, 0F));
		headNode.addOrReplaceChild("right_ear1", CubeListBuilder.create().texOffs(60, 84)
				.addBox(-4F, -1F, -0.5F, 4, 2, 1), PartPose.offsetAndRotation(-2.5F, -2.991261F - 8.730923F, -9.441189F + 1.162896F, 0.3975939F, -0.2030238F, 0.321354F));
		headNode.addOrReplaceChild("right_ear2", CubeListBuilder.create().texOffs(49, 80)
				.addBox(-2.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offsetAndRotation(-4.761655F, -3.719296F - 8.730923F, -10.21893F + 1.162896F, 0.397594F, -0.2030239F, 0.3213542F));
		headNode.addOrReplaceChild("left_ear1", CubeListBuilder.create().texOffs(60, 84)
				.addBox(0F, -1F, -0.5F, 4, 2, 1), PartPose.offsetAndRotation(2.5F, -2.991261F - 8.730923F, -9.441189F + 1.162896F, 0.3975939F, 0.2030238F, -0.321354F));
		headNode.addOrReplaceChild("left_ear2", CubeListBuilder.create().texOffs(49, 80)
				.addBox(1.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offsetAndRotation(4.761655F, -3.719296F - 8.730923F, -10.21893F + 1.162896F, 0.397594F, 0.2030239F, -0.3213542F));
		headNode.addOrReplaceChild("right_horn_bud", CubeListBuilder.create().texOffs(38, 64)
				.addBox(-1.5F, -0.5F, -1.5F, 3, 1, 3), PartPose.offsetAndRotation(-1.8F, -4.996187F - 8.730923F, -8.97186F + 1.162896F, 0.1493225F, -0.1260779F, -0.09751795F));
		headNode.addOrReplaceChild("right_horn1", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -8.5F, -1F, 2, 9, 2), PartPose.offsetAndRotation(-1.691772F, -4.510839F - 8.730923F, -8.884541F + 1.162896F, -0.7281985F, -0.4957605F, -0.5339621F));
		headNode.addOrReplaceChild("right_horn2", CubeListBuilder.create().texOffs(38, 71)
				.addBox(0F, -9.1F, 1.5F, 2, 7, 2), PartPose.offsetAndRotation(-6.85363F, -9.151012F - 8.730923F, -7.733873F + 1.162896F, -1.205367F, -0.2829273F, -0.01425832F));
		headNode.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(8, 111)
				.addBox(-1.5F, -0.5F, -5.5F, 3, 1, 6), PartPose.offsetAndRotation(0F, 2.542599F - 8.730923F, -10.98598F + 1.162896F, 0.2771511F, 0F, 0F));
		headNode.addOrReplaceChild("beard", CubeListBuilder.create().texOffs(31, 111)
				.addBox(-1F, -0.5F, 0F, 2, 5, 4), PartPose.offsetAndRotation(0F, 3.773874F - 8.730923F, -15.31426F + 1.162896F, 0.1083812F, 0F, 0F));
		headNode.addOrReplaceChild("snout3", CubeListBuilder.create().texOffs(9, 86)
				.addBox(-1.5F, 0F, -5F, 3, 2, 5), PartPose.offsetAndRotation(0F, -1.519526F - 8.730923F, -13.70106F + 1.162896F, 0.6541421F, 0F, 0F));
		headNode.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(40, 91)
				.addBox(-1F, 0F, 0F, 2, 2, 2), PartPose.offsetAndRotation(0F, 1.600178F - 8.730923F, -18.27188F + 1.162896F, 0.4028149F, 0F, 0F));
		headNode.addOrReplaceChild("snout1", CubeListBuilder.create().texOffs(11, 76)
				.addBox(-1.5F, 0F, -5.5F, 3, 2, 6), PartPose.offsetAndRotation(-0.01F, -2.721825F - 8.730923F, -14.04308F + 1.162896F, 1.100248F, 0F, 0F));
		headNode.addOrReplaceChild("snout2", CubeListBuilder.create().texOffs(10, 96)
				.addBox(-2F, -0.5F, -5F, 4, 3, 6), PartPose.offsetAndRotation(0F, 0.07593727F - 8.730923F, -13.10778F + 1.162896F, 0.4028149F, 0F, 0F));
		headNode.addOrReplaceChild("left_horn_bud", CubeListBuilder.create().texOffs(38, 64)
				.addBox(-1.5F, -0.5F, -1.5F, 3, 1, 3), PartPose.offsetAndRotation(1.8F, -4.996187F - 8.730923F, -8.97186F + 1.162896F, 0.1493225F, 0.1260779F, 0.09751794F));
		headNode.addOrReplaceChild("left_horn1", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -8.5F, -1F, 2, 9, 2), PartPose.offsetAndRotation(1.691772F, -4.510839F - 8.730923F, -8.884541F + 1.162896F, -0.7281986F, 0.4957606F, 0.5339621F));
		headNode.addOrReplaceChild("left_horn2", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-2F, -9.1F, 1.5F, 2, 7, 2), PartPose.offsetAndRotation(6.853631F, -9.151009F - 8.730923F, -7.733873F + 1.162896F, -1.205367F, 0.2829274F, 0.01425837F));
