...
public class ModelSowLargeBlack<T extends EntityAnimaniaPig> extends EntityModel<T>
{
	...
	public ModelSowLargeBlack(ModelPart root)
	{
	...
	protected static void addLargeBlackEars(PartDefinition head)
	{
		head.addOrReplaceChild("ear1", CubeListBuilder.create().texOffs(3, 28)
				.addBox(-1.5F, -2.5F, -0.5F, 3, 3, 1), PartPose.offset(3F, -2.5F, -7F));
		head.addOrReplaceChild("ear1a", CubeListBuilder.create().texOffs(2, 27)
				.addBox(-1.5F, -0.5F, -1F, 3, 1, 2), PartPose.offset(4.291645F, -4.620012F, -8.55907F));
		head.addOrReplaceChild("ear1b", CubeListBuilder.create().texOffs(3, 28)
				.addBox(-1F, -0.5F, -0.5F, 2, 1, 1), PartPose.offset(3.572421F, -3.51334F, -8.07271F));
