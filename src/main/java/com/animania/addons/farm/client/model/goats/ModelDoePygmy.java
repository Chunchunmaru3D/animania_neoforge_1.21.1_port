...
public class ModelDoePygmy<T extends EntityAnimaniaGoat> extends EntityModel<T>
{
	...
	public ModelDoePygmy(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		...
		root.addOrReplaceChild("right_front_leg", CubeListBuilder.create().texOffs(62, 4)
				.addBox(-1.5F, -1F, -2F, 3, 14, 4), PartPose.offset(-4F, 11.72712F, -1.250051F));
		root.addOrReplaceChild("udder", CubeListBuilder.create().texOffs(7, 14)
				.addBox(-3F, -2F, -3F, 6, 4, 6), PartPose.offset(0F, 15.28831F, 16.50714F));
		root.addOrReplaceChild("udder1", CubeListBuilder.create().texOffs(12, 19)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(2F, 17.78831F, 14.50714F));
		root.addOrReplaceChild("udder2", CubeListBuilder.create().texOffs(12, 19)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(-2F, 17.78831F, 14.50714F));
		root.addOrReplaceChild("udder3", CubeListBuilder.create().texOffs(12, 19)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(-2F, 17.78831F, 18.50714F));
		root.addOrReplaceChild("udder4", CubeListBuilder.create().texOffs(12, 19)
				.addBox(-0.5F, -0.5F, -0.5F, 1, 1, 1), PartPose.offset(2F, 17.78831F, 18.50714F));
