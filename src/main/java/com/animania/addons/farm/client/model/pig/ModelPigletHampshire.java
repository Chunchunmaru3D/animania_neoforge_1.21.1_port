...
public class ModelPigletHampshire<T extends EntityPigletBase> extends EntityModel<T>
{
	...
	public ModelPigletHampshire(ModelPart root)
	{
	...
	protected static PartDefinition buildCommonParts(MeshDefinition mesh)
	{
		...
		root.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(20, 14)
				.addBox(-1F, 0F, -1F, 2, 3, 2), PartPose.offset(2F, 21F, 0.5F));
		root.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(20, 14)
				.addBox(-1F, 0F, -1F, 2, 3, 2), PartPose.offset(-2F, 21F, 0.5F));
