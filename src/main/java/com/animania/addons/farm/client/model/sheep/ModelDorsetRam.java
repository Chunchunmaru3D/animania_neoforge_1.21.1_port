...
public class ModelDorsetRam<T extends EntityAnimaniaSheep> extends EntityModel<T>
{
	...
	private final ModelPart neckWool, neckWool2;
	private final ModelPart leftHorn1, leftHorn2, leftHorn3, rightHorn1, rightHorn2, rightHorn3;

	private boolean sleeping;

	public ModelDorsetRam(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		...
		root.addOrReplaceChild("wool_body1", CubeListBuilder.create().texOffs(40, 100)
				.addBox(-5F, -6.5F, -6F, 10, 15, 12), PartPose.offset(0F, 7.704449F, 7.009472F));
	...
	protected static PartDefinition buildHead(PartDefinition root)
	{
		...
		headNode.addOrReplaceChild("left_horn2", CubeListBuilder.create().texOffs(80, 15)
				.addBox(0F, -1F, -1F, 6, 2, 2), PartPose.offset(3.341148F, -9.424429F, -8.17394F));
		headNode.addOrReplaceChild("left_horn3", CubeListBuilder.create().texOffs(80, 15)
				.addBox(1F, -1F, -1F, 6, 2, 2), PartPose.offset(5.525732F, -10.50908F, -3.13134F));
		headNode.addOrReplaceChild("right_horn2", CubeListBuilder.create().texOffs(80, 15)
				.addBox(-6F, -1F, -1F, 6, 2, 2), PartPose.offset(-3.341148F, -9.42443F, -8.17394F));
		headNode.addOrReplaceChild("right_horn3", CubeListBuilder.create().texOffs(80, 15)
				.addBox(-7F, -1F, -1F, 6, 2, 2), PartPose.offset(-5.525732F, -10.509082F, -3.13134F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		this.rightHorn1.xRot = 0.08560022F; this.rightHorn1.yRot = 0.5243015F; this.rightHorn1.zRot = 0.8645297F;
		this.leftHorn2.xRot = 0.05121709F; this.leftHorn2.yRot = -0.9075357F; this.leftHorn2.zRot = 0.06658725F;
		this.leftHorn3.xRot = -0.2553108F; this.leftHorn3.yRot = 0.15F; this.leftHorn3.zRot = 1.064569F;
		this.rightHorn2.xRot = 0.05121716F; this.rightHorn2.yRot = 0.9075359F; this.rightHorn2.zRot = -0.06658728F;
		this.rightHorn3.xRot = -0.2553108F; this.rightHorn3.yRot = -0.15F; this.rightHorn3.zRot = -1.064569F;
