...
public class ModelBuckAngora<T extends EntityAnimaniaGoat> extends EntityModel<T>
{
	...
	public ModelBuckAngora(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		...
		root.addOrReplaceChild("reproductive1", CubeListBuilder.create().texOffs(22, 38)
				.addBox(-1F, -2F, -2F, 2, 4, 4), PartPose.offsetAndRotation(0F, 13.20496F, 15.5981F, 0.07853982F, 0F, 0F));
		root.addOrReplaceChild("reproductive2", CubeListBuilder.create().texOffs(10, 37)
				.addBox(-1.5F, -2F, -1F, 3, 4, 2), PartPose.offsetAndRotation(0F, 13.05019F, 17.56459F, 0.07853982F, 0F, 0F));
	...
	protected static PartDefinition buildHead(PartDefinition root)
	{
		...
		headNode.addOrReplaceChild("right_horn3", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -6F, -1F, 2, 6, 2), PartPose.offsetAndRotation(-12.27423F, -9.172562F - 7.738533F, -3.402195F + 0.9885842F, -1.085297F, -0.5934884F, -0.3137805F));
		...
		headNode.addOrReplaceChild("beard", CubeListBuilder.create().texOffs(31, 111)
				.addBox(-1F, -2F, 0F, 2, 8, 4), PartPose.offsetAndRotation(0F, 3.543264F - 7.738533F, -14.72607F + 0.9885842F, 0.1083812F, 0F, 0F));
		...
		headNode.addOrReplaceChild("left_horn3", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -6F, -1F, 2, 6, 2), PartPose.offsetAndRotation(12.27422F, -9.172562F - 7.738533F, -3.402196F + 0.9885842F, -1.085297F, 0.5934881F, 0.3137808F));
