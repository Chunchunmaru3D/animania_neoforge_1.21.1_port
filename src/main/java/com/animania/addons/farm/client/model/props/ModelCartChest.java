...
public class ModelCartChest<T extends EntityCart> extends EntityModel<T>
{
	private static final ResourceLocation MODEL_KEY = ResourceLocation.fromNamespaceAndPath(Animania.MODID, "entity/model_cart_chest");
	private static final ResourceLocation ANIM_KEY = ResourceLocation.fromNamespaceAndPath(Animania.MODID, "entity/anim_cart_chest");
	...
	public ModelCartChest(ModelPart root)
	{
		this.root = root;
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color)
	{
		...
		this.root.getChild("Chest1").render(poseStack, buffer, packedLight, packedOverlay, color);
	}
}
