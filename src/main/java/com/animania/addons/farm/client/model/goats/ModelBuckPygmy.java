...
public class ModelBuckPygmy<T extends EntityAnimaniaGoat> extends EntityModel<T>
{
	...
	public ModelBuckPygmy(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(81, 5)
				.addBox(-5F, -6F, -6.5F, 10, 12, 13), PartPose.offset(0F, 9F, 2F));
		...
		root.addOrReplaceChild("reproductive1", CubeListBuilder.create().texOffs(22, 38)
				.addBox(-1F, -2F, -2F, 2, 4, 4), PartPose.offsetAndRotation(0F, 14.03065F, 13.60571F, 0.07853982F, 0F, 0F));
		root.addOrReplaceChild("reproductive2", CubeListBuilder.create().texOffs(10, 37)
				.addBox(-1.5F, -2F, -1F, 3, 4, 2), PartPose.offsetAndRotation(0F, 13.87588F, 15.5722F, 0.07853982F, 0F, 0F));
	...
	protected static PartDefinition buildHead(PartDefinition root)
	{
		...
		headNode.addOrReplaceChild("right_horn1", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -6.5F, -1F, 2, 5, 2), PartPose.offsetAndRotation(-1.06411F, -1.984159F - 10.73092F, -8.833616F + 1.162896F, -0.6566104F, 0.013392F, -0.3415253F));
		headNode.addOrReplaceChild("right_horn2", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-0.25F, -5F, -1F, 1, 4, 2), PartPose.offsetAndRotation(-2.798228F, -5.939657F - 10.73092F, -5.761665F + 1.162896F, -0.8807439F, 0.139558F, -0.4298474F));
		...
		headNode.addOrReplaceChild("beard", CubeListBuilder.create().texOffs(31, 111)
				.addBox(-1F, -1F, 0F, 2, 6, 4), PartPose.offsetAndRotation(0F, 5.209013F - 10.73092F, -14.48907F + 1.162896F, 0.1083812F, 0F, 0F));
		...
		headNode.addOrReplaceChild("left_horn1", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -6.5F, -1F, 2, 5, 2), PartPose.offsetAndRotation(1.064111F, -1.984159F - 10.73092F, -8.833616F + 1.162896F, -0.6566105F, -0.01339201F, 0.3415253F));
		headNode.addOrReplaceChild("left_horn2", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-0.75F, -5F, -1F, 1, 4, 2), PartPose.offsetAndRotation(2.798228F, -5.939657F - 10.73092F, -5.761665F + 1.162896F, -0.8807437F, -0.139558F, 0.4298474F));
