...
public class ModelBuckAlpine<T extends EntityAnimaniaGoat> extends EntityModel<T>
{
	...
	private final ModelPart rightHornBud, leftHornBud, rightHorn1, rightHorn2, rightHorn3, leftHorn1, leftHorn2, leftHorn3;
	private final ModelPart mouth, beard, snout1, snout2, snout3, nose;

	private boolean sleeping;

	public ModelBuckAlpine(ModelPart root)
	{
	...
	protected static PartDefinition buildBody(PartDefinition root)
	{
		...
		root.addOrReplaceChild("reproductive1", CubeListBuilder.create().texOffs(22, 38)
				.addBox(-1F, -2F, -2F, 2, 4, 4), PartPose.offset(0F, 13.29212F, 16.5943F));
		root.addOrReplaceChild("reproductive2", CubeListBuilder.create().texOffs(10, 37)
				.addBox(-1.5F, -2F, -1F, 3, 4, 2), PartPose.offset(0F, 13.46643F, 18.58669F));
	...
	protected static PartDefinition buildHead(PartDefinition root)
	{
		...
		headNode.addOrReplaceChild("right_horn1", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -7.5F, -1F, 2, 7, 2), PartPose.offset(-1.691772F, -5.63872F - 7.738533F, -8.63936F + 0.9885842F));
		headNode.addOrReplaceChild("right_horn2", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -7.5F, -1F, 2, 7, 2), PartPose.offset(-3.712005F, -10.69292F - 7.738533F, -5.073734F + 0.9885842F));
		headNode.addOrReplaceChild("right_horn3", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -6F, -1F, 2, 6, 2), PartPose.offset(-6.09127F, -10.93122F - 7.738533F, 1.051931F + 0.9885842F));
		...
		headNode.addOrReplaceChild("left_horn2", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -7.5F, -1F, 2, 7, 2), PartPose.offset(3.712005F, -10.69292F - 7.738533F, -5.073734F + 0.9885842F));
		headNode.addOrReplaceChild("left_horn3", CubeListBuilder.create().texOffs(38, 71)
				.addBox(-1F, -6F, -1F, 2, 6, 2), PartPose.offset(6.09127F, -10.93122F - 7.738533F, 1.051931F + 0.9885842F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		this.reproductive1.xRot = 0.07853982F;
		this.reproductive2.xRot = 0.07853982F;
		...
		this.rightHorn1.xRot = -0.7273443F; this.rightHorn1.yRot = -0.4953492F; this.rightHorn1.zRot = -0.01269654F;
		this.rightHorn2.xRot = -1.890043F; this.rightHorn2.zRot = 1.380272F;
		this.rightHorn3.xRot = -0.8089435F; this.rightHorn3.zRot = 3.165597F;
		this.mouth.xRot = 0.278122F;
		this.beard.xRot = 0.1093521F;
		...
		this.leftHorn1.xRot = -0.7273443F; this.leftHorn1.yRot = 0.4953492F; this.leftHorn1.zRot = 0.01269654F;
		this.leftHorn2.xRot = -1.890043F; this.leftHorn2.zRot = -1.380272F;
		this.leftHorn3.xRot = -0.8089435F; this.leftHorn3.zRot = -3.165597F;
