...
public class ModelDraftHorseStallion<T extends EntityAnimaniaHorse> extends EntityModel<T>
{
	...
	private final ModelPart block1, block2;
	...
	public ModelDraftHorseStallion(ModelPart root)
	{
	...
	protected static PartDefinition buildSaddle(PartDefinition root)
	{
		...
		root.addOrReplaceChild("block1", CubeListBuilder.create().texOffs(46, 0)
				.addBox(-2F, -2F, -1.5F, 4, 4, 3), PartPose.offset(0F, 6F, 16F));
		root.addOrReplaceChild("block2", CubeListBuilder.create().texOffs(46, 13)
				.addBox(-1F, -2F, -3F, 2, 4, 6), PartPose.offsetAndRotation(0F, 4.5F, 12F, 0.2617994F, 0F, 0F));
