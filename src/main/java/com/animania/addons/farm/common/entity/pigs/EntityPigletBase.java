...
public class EntityPigletBase extends EntityAnimaniaPig implements IChild
{
	protected static final EntityDataAccessor<Optional<UUID>> PARENT_UNIQUE_ID = SynchedEntityData.defineId(EntityPigletBase.class, EntityDataSerializers.OPTIONAL_UUID);
	protected static final EntityDataAccessor<Float> ENTITY_AGE = SynchedEntityData.defineId(EntityPigletBase.class, EntityDataSerializers.FLOAT);

	protected int ageTimer;

	public EntityPigletBase(EntityType<? extends EntityPigletBase> entityType, Level level)
	{
	...
	public static AttributeSupplier.Builder createPigletAttributes()
	{
	...
	protected SoundEvent getAmbientSound()
	{
		return GenericBehavior.getAmbientSound(this,
				FarmSounds.PIGLET_1.get(), FarmSounds.PIGLET_2.get(), FarmSounds.PIGLET_3.get(),
				FarmSounds.PIG_1.get(), FarmSounds.PIG_2.get());
	}
	...
	{
		return GenericBehavior.getRandomSound(FarmSounds.PIGLET_HURT_1.get(), FarmSounds.PIGLET_HURT_2.get(), FarmSounds.PIGLET_HURT_3.get());
	}
	...
	@Override
	public EntityPigletBase getBreedOffspring(net.minecraft.server.level.ServerLevel level, net.minecraft.world.entity.AgeableMob otherParent)
	{
		return null;
	}
