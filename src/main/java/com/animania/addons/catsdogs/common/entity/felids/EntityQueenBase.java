...
public class EntityQueenBase extends EntityAnimaniaCat implements IMateable, IImpregnable
{
	protected static final EntityDataAccessor<Boolean> PREGNANT = SynchedEntityData.defineId(EntityQueenBase.class, EntityDataSerializers.BOOLEAN);
	protected static final EntityDataAccessor<Boolean> HAS_KIDS = SynchedEntityData.defineId(EntityQueenBase.class, EntityDataSerializers.BOOLEAN);
	protected static final EntityDataAccessor<Boolean> FERTILE = SynchedEntityData.defineId(EntityQueenBase.class, EntityDataSerializers.BOOLEAN);
	protected static final EntityDataAccessor<Integer> GESTATION_TIMER = SynchedEntityData.defineId(EntityQueenBase.class, EntityDataSerializers.INT);
	protected static final EntityDataAccessor<Optional<UUID>> MATE_UNIQUE_ID = SynchedEntityData.defineId(EntityQueenBase.class, EntityDataSerializers.OPTIONAL_UUID);

	public int dryTimer;

	public EntityQueenBase(EntityType<? extends EntityQueenBase> entityType, Level level)
	{
	...
	{
		return EntityAnimaniaCat.createAttributes();
	}
	...
	@Override
	public EntityQueenBase getBreedOffspring(net.minecraft.server.level.ServerLevel level, AgeableMob otherParent)
	{
		return null;
	}
