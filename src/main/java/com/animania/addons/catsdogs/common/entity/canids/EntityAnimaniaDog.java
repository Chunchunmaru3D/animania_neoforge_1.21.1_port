...
public class EntityAnimaniaDog extends Wolf implements IAnimaniaAnimalBase
{
	...
	protected static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(EntityAnimaniaDog.class, EntityDataSerializers.INT);
	protected static final EntityDataAccessor<Integer> BLINK_TIMER = SynchedEntityData.defineId(EntityAnimaniaDog.class, EntityDataSerializers.INT);

	private int fedTimer;
	protected int wateredTimer;
	protected int happyTimer;
	protected int damageTimer;
	public DogType type = DogType.LABRADOR;
	...
	public EntityAnimaniaDog(EntityType<? extends EntityAnimaniaDog> entityType, Level level)
	{
	...
	protected void registerGoals()
	{
		...
		this.goalSelector.addGoal(5, new com.animania.common.entity.generic.ai.GenericAIFollowOwnerGoal(this, 1.5D, 5.0F, 30.0F));
		this.goalSelector.addGoal(6, new PanicGoal(this, 1.5D));
		this.goalSelector.addGoal(7, new TemptGoal(this, 1.2D, stack -> AnimaniaHelper.containsItemStack(this.getFoodItems(), stack), false));
		...
		if (AnimaniaConfig.gameRules.animalsSleep.get())
		{
			this.goalSelector.addGoal(12, new GenericAISleepGoal<>(this, 0.8,
					AnimaniaHelper.getBlock(CatsDogsConfig.settings.dogBed.get()),
					AnimaniaHelper.getBlock(CatsDogsConfig.settings.dogBed2.get())));
		}
	...
	public void addAdditionalSaveData(CompoundTag tag)
	{
		...
		tag.putInt("Variant", this.getCoatVariant());
	...
	public void readAdditionalSaveData(CompoundTag tag)
	{
		...
		if (tag.contains("Variant"))
			this.setCoatVariant(tag.getInt("Variant"));
	...
	public int getCoatVariant() { return this.entityData.get(VARIANT); }

	public void setCoatVariant(int variant)
	{
		this.entityData.set(VARIANT, this.getVariantCount() > 0 ? Math.floorMod(variant, this.getVariantCount()) : 0);
	}
	...
	public int getBlinkColor()
	{
		...
		{
			case BLOODHOUND -> -5938636;
			case CHIHUAHUA -> this.getEyeColorForVariant(this.getCoatVariant());
			case COLLIE -> -12570587;
			case CORGI -> -263173;
			case DACHSHUND -> 0;
			case GERMAN_SHEPHERD, GREAT_DANE -> -8300224;
			case GREYHOUND -> -7578572;
			case HUSKY -> 0xC4C4C4;
			case LABRADOR -> -4153993;
			case POMERANIAN -> -197380;
			case POODLE -> -658707;
			case PUG -> -1514529;
			case WOLF -> -4409680;
			default -> 0xFFFFFF;
	...
	{
		if (this.type == DogType.FOX)
			return this.getSleeping() ? null : net.minecraft.sounds.SoundEvents.FOX_AMBIENT;
	...
	@Override
	@Nullable
	public Wolf getBreedOffspring(net.minecraft.server.level.ServerLevel level, AgeableMob otherParent)
	{
		return null;
	}
	...
	{
		return Sets.newHashSet(AnimaniaHelper.getItemStackArray(CatsDogsConfig.settings.dogFood.get()));
	}
