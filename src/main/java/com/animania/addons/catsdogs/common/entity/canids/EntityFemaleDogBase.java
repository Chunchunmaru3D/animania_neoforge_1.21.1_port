...
public class EntityFemaleDogBase extends EntityAnimaniaDog implements IMateable, IImpregnable
{
	protected static final EntityDataAccessor<Boolean> PREGNANT = SynchedEntityData.defineId(EntityFemaleDogBase.class, EntityDataSerializers.BOOLEAN);
	protected static final EntityDataAccessor<Boolean> HAS_KIDS = SynchedEntityData.defineId(EntityFemaleDogBase.class, EntityDataSerializers.BOOLEAN);
	protected static final EntityDataAccessor<Boolean> FERTILE = SynchedEntityData.defineId(EntityFemaleDogBase.class, EntityDataSerializers.BOOLEAN);
	protected static final EntityDataAccessor<Integer> GESTATION_TIMER = SynchedEntityData.defineId(EntityFemaleDogBase.class, EntityDataSerializers.INT);
	protected static final EntityDataAccessor<Optional<UUID>> MATE_UNIQUE_ID = SynchedEntityData.defineId(EntityFemaleDogBase.class, EntityDataSerializers.OPTIONAL_UUID);

	public int dryTimer;

	public EntityFemaleDogBase(EntityType<? extends EntityFemaleDogBase> entityType, Level level)
	{
	...
	public static AttributeSupplier.Builder createFemaleAttributes()
	{
	...
	@Override
	public EntityFemaleDogBase getBreedOffspring(net.minecraft.server.level.ServerLevel level, AgeableMob otherParent)
	{
		return null;
	}
