...
public class EntityKittenBase extends EntityAnimaniaCat implements IChild
{
	protected static final EntityDataAccessor<Float> ENTITY_AGE = SynchedEntityData.defineId(EntityKittenBase.class, EntityDataSerializers.FLOAT);
	protected static final EntityDataAccessor<Optional<UUID>> PARENT_UNIQUE_ID = SynchedEntityData.defineId(EntityKittenBase.class, EntityDataSerializers.OPTIONAL_UUID);

	protected int ageTimer;

	public EntityKittenBase(EntityType<? extends EntityKittenBase> entityType, Level level)
	{
	...
	public static AttributeSupplier.Builder createKittenAttributes()
	{
	...
	@Override
	public EntityKittenBase getBreedOffspring(net.minecraft.server.level.ServerLevel level, net.minecraft.world.entity.AgeableMob otherParent)
	{
		return null;
	}
