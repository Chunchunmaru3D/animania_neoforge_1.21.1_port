...
public class ModelCatTabby
{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition lowerBody = addPart(body, "lower_body", 77, 42, -3.5F, -4.5F, -6.0F, 7, 9, 12,
				0.0F, -1.0F, 4.0F, 0.0F, 1.0F, 6.0F, -2.529F, 0.0F, 0.0F);
		PartDefinition tail = addPart(lowerBody, "tail", 44, 16, -1.0F, -1.5F, -4.5F, 2, 3, 9,
				0.0F, -3.0F, 6.0F, 0.0F, 1.0F, 3.0F, -50.147F, 0.0F, 0.0F);
		PartDefinition tail2 = addPart(tail, "tail2", 71, 27, -1.0F, -1.5F, -2.5F, 2, 3, 5,
				0.0F, 0.0F, 3.0F, 0.0F, -0.0F, 3.0F, 12.435F, 0.0F, 0.0F);
		...
		addPart(cheekL, "cheek_l2", 32, 36, -1.5F, -1.5F, -1.0F, 3, 3, 2,
				-1.0F, 0.6F, 1.5F, 2.0F, -0.6F, -1.0F, 0.0F, 13.756F, 0.0001F);
		PartDefinition earR = addPart(headBase, "ear_r", 3, 3, -1.5F, -0.5F, -2.0F, 3, 1, 4,
				-2.5F, -2.7F, 0.7F, -0.5F, -0.6F, -0.5F, -59.166F, 83.628F, -67.211F);
		...
		PartDefinition earL = addPart(headBase, "ear_l", 3, 3, -1.5F, -0.5F, -2.0F, 3, 1, 4,
				2.5F, -2.7F, 0.7F, 0.5F, -0.6F, -0.5F, -59.166F, -83.626F, 67.212F);
	...
	private static Map<String, CatPartPose> buildBaseline()
	{
		...
		m.put("neck1", new CatPartPose(0.0F, 0.0F, -3.0F, -0.566649066927991F, 0.0F, 0.0F));
		...
		m.put("jaw", new CatPartPose(0.0F, 2.4F, -1.0F, -0.009829694347232064F, 0.0F, 0.0F));
		m.put("cheek_r", new CatPartPose(-1.0F, 0.5F, 2.0F, 0.0F, -0.16720254234105678F, -0.12217304763960307F));
		m.put("cheek_r2", new CatPartPose(1.0F, 0.6F, 1.5F, 0.0F, -0.24005258531930007F, 0.0F));
		m.put("cheek_l", new CatPartPose(1.0F, 0.5F, 2.0F, 0.0F, 0.16720254234105678F, 0.12217304763960307F));
		m.put("cheek_l2", new CatPartPose(-1.0F, 0.6F, 1.5F, 0.0F, 0.24005433064855206F, 1.7453292519943296E-6F));
		m.put("ear_r", new CatPartPose(-2.5F, -2.7F, 0.7F, -1.0327043370880369F, 1.4596223441013618F, -1.1730881501429486F));
		...
		m.put("ear_l", new CatPartPose(2.5F, -2.7F, 0.7F, -1.0327043370880369F, -1.4596205987721098F, 1.1730898954722007F));
