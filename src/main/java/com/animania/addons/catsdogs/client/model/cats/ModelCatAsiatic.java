...
public class ModelCatAsiatic
{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		addPart(headBase, "jaw", 1, 21, -1.5F, -0.5F, -2.0F, 3, 1, 4,
				0.0F, 2.5F, -0.4F, 0.0F, -0.2F, -1.0F, -0.5632F, 0.0F, 0.0F);
		PartDefinition cheekR = addPart(headBase, "cheek_r", 32, 41, -1.5F, -2.5F, -1.5F, 3, 5, 3,
				-1.0F, 0.5F, 2.0F, -2.0F, -0.6F, -1.0F, 0.0F, -9.58F, -7.0F);
		...
		PartDefinition earR = addPart(headBase, "ear_r", 3, 3, -1.5F, -0.5F, -2.0F, 3, 1, 4,
				-2.5F, -2.7F, 0.7F, -0.5F, -0.6F, -0.5F, -65.0001F, 110.0F, -80.0F);
		...
		PartDefinition earL = addPart(headBase, "ear_l", 3, 3, -1.5F, -0.5F, -2.0F, 3, 1, 4,
				2.5F, -2.7F, 0.7F, 0.5F, -0.6F, -0.5F, -65.0001F, -110.0F, 80.0001F);
	...
	private static Map<String, CatPartPose> buildBaseline()
	{
		...
		m.put("head_base", new CatPartPose(0.0F, -2.0F, -2.3F, 0.77376030794515F, 0.0F, 0.0F));
		m.put("head_front", new CatPartPose(0.0F, 1.4F, 1.5F, 0.08333772645347724F, 0.0F, 0.0F));
		...
		m.put("jaw", new CatPartPose(0.0F, 2.5F, -0.4F, -0.009829694347232064F, 0.0F, 0.0F));
		...
		m.put("ear_r", new CatPartPose(-2.5F, -2.7F, 0.7F, -1.1344657591255662F, 1.9198621771937625F, -1.3962634015954636F));
		...
		m.put("ear_l", new CatPartPose(2.5F, -2.7F, 0.7F, -1.1344657591255662F, -1.9198621771937625F, 1.3962651469247156F));
