...
public class EntityRabbitKitBase extends EntityAnimaniaRabbit implements IChild
{
	protected static final EntityDataAccessor<Float> ENTITY_AGE = SynchedEntityData.defineId(EntityRabbitKitBase.class, EntityDataSerializers.FLOAT);
	protected static final EntityDataAccessor<Optional<UUID>> PARENT_UNIQUE_ID = SynchedEntityData.defineId(EntityRabbitKitBase.class, EntityDataSerializers.OPTIONAL_UUID);

	protected int ageTimer;

	public EntityRabbitKitBase(EntityType<? extends EntityRabbitKitBase> entityType, Level level)
	{
	...
	public static AttributeSupplier.Builder createKitAttributes()
	{
	...
	@Override
	public EntityRabbitKitBase getBreedOffspring(net.minecraft.server.level.ServerLevel level, net.minecraft.world.entity.AgeableMob otherParent)
	{
		return null;
	}
