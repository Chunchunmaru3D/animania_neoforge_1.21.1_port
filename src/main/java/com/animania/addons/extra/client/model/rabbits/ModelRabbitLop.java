...
public class ModelRabbitLop<T extends EntityAnimaniaRabbit> extends EntityModel<T>
{
	private final ModelPart root;
	private final ModelPart lowerBody, tail, backLegR1, backLegR2, backLegL1, backLegL2, legL1, legR1, neck;

	public ModelRabbitLop(ModelPart root)
	{
		this.root = root;
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		part(root, "tail", 50, 18, -1.5F, -2, -1.7F, 3, 3, 4, 0, 19.29693F, 14.870147F, -1.548105F, -Mth.PI, -Mth.PI);
		...
		PartDefinition earR1 = part(neck, "ear_r1", 25, 0, -1, -1.1F, -.7F, 2, 1, 2, -3, -5.1664F, -3.121248F, -.7976383F, 1.35309F, .1836136F);
		part(earR1, "ear_r2", 3, 0, -1.5F, -1.1F, 0, 3, 1, 7, -1.092489F, 4.748962F, 3.828171F, -2.233634F, 0, -3.030268F);
		PartDefinition earL1 = part(neck, "ear_l1", 25, 0, -1, -1.1F, -.7F, 2, 1, 2, 3, -5.1664F, -3.121248F, -.7976383F, -1.35309F, -.1836136F);
		part(earL1, "ear_l2", 3, 0, -1.5F, -1.1F, 0, 3, 1, 7, 1.024298F, 4.820533F, 3.843255F, -2.233634F, 0, 3.030268F);
