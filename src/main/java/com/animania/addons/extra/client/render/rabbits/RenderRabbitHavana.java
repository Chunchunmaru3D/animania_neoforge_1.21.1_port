...
import com.animania.addons.extra.client.model.rabbits.ModelRabbitHavana;
...
public class RenderRabbitHavana<T extends EntityAnimaniaRabbit> extends MobRenderer<T, ModelRabbitHavana<T>>
{
	public static final ModelLayerLocation LAYER = new ModelLayerLocation(
			ResourceLocation.fromNamespaceAndPath(Animania.MODID, "rabbit_havana"), "main");
	private static final ResourceLocation TEXTURE = texture("rabbit_havana");
	private static final ResourceLocation KILLER = texture("rabbit_killer");

	public RenderRabbitHavana(EntityRendererProvider.Context context)
	{
		super(context, new ModelRabbitHavana<>(context.bakeLayer(LAYER)), .25F);
