...
import com.animania.client.model.placeholder.ModelToad;
...
public class RenderToad<T extends Mob> extends MobRenderer<T, ModelToad<T>>
{
	public static final ModelLayerLocation LAYER =
			new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Animania.MODID, "toad"), "main");

	private final Function<T, ResourceLocation> textureResolver;

	public RenderToad(EntityRendererProvider.Context context, Function<T, ResourceLocation> textureResolver)
	{
		super(context, new ModelToad<>(context.bakeLayer(LAYER)), 0.2F);
