...
public class LayerBlinkingSheep<T extends EntityAnimaniaSheep, M extends EntityModel<T>> extends RenderLayer<T, M>
{
	public LayerBlinkingSheep(RenderLayerParent<T, M> renderer)
	{
		super(renderer);
	}
