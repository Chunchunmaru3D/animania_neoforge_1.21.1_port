...
public class LayerBlinkingGoat<T extends EntityAnimaniaGoat, M extends EntityModel<T>> extends RenderLayer<T, M>
{
	public LayerBlinkingGoat(RenderLayerParent<T, M> renderer)
	{
		super(renderer);
	}
