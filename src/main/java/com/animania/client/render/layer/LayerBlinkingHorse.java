...
public class LayerBlinkingHorse<T extends EntityAnimaniaHorse, M extends EntityModel<T>> extends RenderLayer<T, M>
{
	public LayerBlinkingHorse(RenderLayerParent<T, M> renderer)
	{
		super(renderer);
	}
