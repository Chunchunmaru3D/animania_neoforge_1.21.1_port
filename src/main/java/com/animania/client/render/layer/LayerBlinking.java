...
public class LayerBlinking<T extends EntityAnimaniaChicken, M extends EntityModel<T>> extends RenderLayer<T, M>
{
	public LayerBlinking(RenderLayerParent<T, M> renderer)
	{
		super(renderer);
	}
			...
			float limbSwing, float limbSwingAmount, float partialTick, float ageInTicks, float netHeadYaw, float headPitch)
	{
		...
		renderLid(poseStack, bufferSource, packedLight, entity, left, color);
		renderLid(poseStack, bufferSource, packedLight, entity, right, color);
	}

	private void renderLid(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, T entity,
