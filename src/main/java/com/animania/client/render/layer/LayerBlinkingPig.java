...
public class LayerBlinkingPig<T extends EntityAnimaniaPig, M extends EntityModel<T>> extends RenderLayer<T, M>
{
	public LayerBlinkingPig(RenderLayerParent<T, M> renderer)
	{
		super(renderer);
	}
