...
public class ModelPeafowl<T extends Mob> extends EntityModel<T>
{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition HeadDef = NeckDef.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0)
				...
				PartPose.offsetAndRotation(0.0F, -6.590264000000001F, -3.552853F, 0.07594994F, 0.0F, 0.0F));
		...
		PartDefinition BeakTopDef = NeckDef.addOrReplaceChild("BeakTop", CubeListBuilder.create().texOffs(19, 0)
				...
				PartPose.offsetAndRotation(0.0F, -7.5296140000000005F, -6.515235F, 0.3341772F, 0.0F, 0.0F));

		PartDefinition BeakBottomDef = NeckDef.addOrReplaceChild("BeakBottom", CubeListBuilder.create().texOffs(19, 0)
				.addBox(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 2.0F),
				PartPose.offsetAndRotation(0.0F, -7.227936000000001F, -6.610052F, 0.07594992F, 0.0F, 0.0F));

		PartDefinition CrestDef = NeckDef.addOrReplaceChild("Crest", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, -10.884921F, -3.1274940000000004F, -0.1465151F, 0.0F, 0.0F));
		...
		PartDefinition Foot1bDef = leg1TopDef.addOrReplaceChild("Foot1b", CubeListBuilder.create().texOffs(25, 0)
				.addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F),
				PartPose.offsetAndRotation(0.75F, 6.153760000000002F, -0.5548139999999999F, 0F, 0F, 0F));
		...
		PartDefinition Foot2bDef = leg2TopDef.addOrReplaceChild("Foot2b", CubeListBuilder.create().texOffs(25, 0)
				.addBox(-0.5F, -0.5F, -1.5F, 1.0F, 1.0F, 3.0F),
				PartPose.offsetAndRotation(0.75F, 6.194890000000001F, -0.551912F, 0F, 0F, 0F));

		PartDefinition Wing1Def = root.addOrReplaceChild("Wing1", CubeListBuilder.create().texOffs(2, 40)
				.addBox(-0.5F, -1.5F, -1.5F, 1.0F, 3.0F, 7.0F),
				PartPose.offsetAndRotation(-3.5F, 12.860299999999999F, 0.1172086F, -0.2947292F, 0.0F, 0.0F));

		PartDefinition Wing1aDef = Wing1Def.addOrReplaceChild("Wing1a", CubeListBuilder.create().texOffs(3, 40)
				.addBox(-0.5F, -1.0F, 1.0F, 1.0F, 2.0F, 2.0F),
				PartPose.offsetAndRotation(0.0F, 0.0071600000000013875F, 4.3059634F, 0F, 0F, 0F));

		PartDefinition Wing1bDef = Wing1Def.addOrReplaceChild("Wing1b", CubeListBuilder.create().texOffs(3, 40)
				.addBox(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 6.0F),
				PartPose.offsetAndRotation(0.0F, 1.91376F, -0.5809618F, 0F, 0F, 0F));

		PartDefinition Wing2Def = root.addOrReplaceChild("Wing2", CubeListBuilder.create().texOffs(2, 40)
				.addBox(-0.5F, -1.5F, -1.5F, 1.0F, 3.0F, 7.0F),
				PartPose.offsetAndRotation(3.5F, 12.860299999999999F, 0.1172086F, -0.2947292F, 0.0F, 0.0F));

		PartDefinition Wing2aDef = Wing2Def.addOrReplaceChild("Wing2a", CubeListBuilder.create().texOffs(3, 40)
				.addBox(-0.5F, -1.0F, 1.0F, 1.0F, 2.0F, 2.0F),
				PartPose.offsetAndRotation(0.0F, 0.0071600000000013875F, 4.3059634F, 0F, 0F, 0F));

		PartDefinition Wing2bDef = Wing2Def.addOrReplaceChild("Wing2b", CubeListBuilder.create().texOffs(3, 40)
				.addBox(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 6.0F),
				PartPose.offsetAndRotation(0.0F, 1.91376F, -0.5809618F, 0F, 0F, 0F));
